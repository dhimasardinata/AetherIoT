...
struct LocalAppConfig {
    struct System {
        static constexpr std::string_view DEVICE_NAME   = "Aether-Agri-Node";
        static constexpr std::string_view FIRMWARE_VER  = "0.0.1";
        static constexpr std::string_view HARDWARE_REV  = "SOLAR-V2";
    };

    struct Connectivity {
        static constexpr std::string_view DEFAULT_SSID  = "AgriMesh_AP";
        static constexpr std::string_view DEFAULT_PASS  = "AgriPass123";
        static constexpr std::string_view AP_FALLBACK_SSID = "AETHER-AGRI-AP";
