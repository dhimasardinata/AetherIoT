...
struct LocalAppConfig {
    struct System {
        static constexpr std::string_view DEVICE_NAME   = "Aether-Quickstart";
        static constexpr std::string_view FIRMWARE_VER  = "0.0.1";
        static constexpr std::string_view HARDWARE_REV  = "REV-1.0";
    };

    struct Connectivity {
        static constexpr std::string_view DEFAULT_SSID  = "Aether_WiFi";
        static constexpr std::string_view DEFAULT_PASS  = "AetherPass123";
        static constexpr std::string_view AP_FALLBACK_SSID = "AETHER-CONFIG";
