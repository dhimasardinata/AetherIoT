...
struct LocalAppConfig {
    struct System {
        static constexpr std::string_view DEVICE_NAME   = "Aether-Multi-Servo-Mux";
        static constexpr std::string_view FIRMWARE_VER  = "0.0.1";
        static constexpr std::string_view HARDWARE_REV  = "SERVO-MUX-1.0";
    };

    struct Connectivity {
        static constexpr std::string_view DEFAULT_SSID  = "Industrial_Mesh_AP";
        static constexpr std::string_view DEFAULT_PASS  = "MeshSecret2026";
        static constexpr std::string_view AP_FALLBACK_SSID = "AETHER-MUX-AP";
        static constexpr std::string_view AP_FALLBACK_PASS = "12345678";
    };

    struct Timing {
        static constexpr uint32_t LOOP_INTERVAL_MS      = 500;
        static constexpr uint32_t TELEMETRY_INTERVAL_MS = 1500;
