...
struct LocalAppConfig {
    struct System {
        static constexpr std::string_view DEVICE_NAME   = "Aether-Weather-Station";
        static constexpr std::string_view FIRMWARE_VER  = "0.0.1";
        static constexpr std::string_view HARDWARE_REV  = "WEATHER-PRO-2";
    };

    struct Connectivity {
        static constexpr std::string_view DEFAULT_SSID  = "WeatherNet_WiFi";
        static constexpr std::string_view DEFAULT_PASS  = "WeatherPass2026";
        static constexpr std::string_view AP_FALLBACK_SSID = "AETHER-WEATHER-AP";
